/* forward euler solver to test design
    ...
    */
export function forward_euler(derivative, initial, dt, t_final, parameters) {
...
export function leap_frog(derivative, initial, dt, t_final, parameters) {
    var d = initial.length;
    var N = Math.floor(t_final / dt);
    var result = new Float32Array(N * d);
    var t = new Float32Array(N);
...
export function ab2 (derivative, initial, dt, t_final, parameters) {
    var d = initial.length;
    var N = Math.floor(t_final / dt);
    var result = new Float32Array(N * d);
    var t = new Float32Array(N);
...
export function heun (derivative, initial, dt, t_final, parameters) {
    var d = initial.length;
    var N = Math.floor(t_final / dt);
    var result = new Float32Array(N * d);
    var t = new Float32Array(N);
